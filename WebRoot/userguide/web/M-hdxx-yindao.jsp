...
<title>初高中生互动学习引导</title>
<link href="../css/w1200/M-hdxx-yindao.css" id="cssName" rel="stylesheet" type="text/css">
...
$(document).ready(function(){
	...
	if (clienW >= 1280) {
		$("#cssName").attr("href","../css/w1200/M-hdxx-yindao.css");
	}else{
		$("#cssName").attr("href","../css/w980/M-hdxx-yindao.css");
		}

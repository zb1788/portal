...
<html>
<head>
<title>初高中生同步学习引导</title>
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7"/>
<link href="../css/w1200/M-tbxx-yindao.css" id="cssName" rel="stylesheet" type="text/css">
...
$(document).ready(function(){
	...
	if (clienW >= 1280) {
		$("#cssName").attr("href","../css/w1200/M-tbxx-yindao.css");
	}else{
		$("#cssName").attr("href","../css/w980/M-tbxx-yindao.css");
		}

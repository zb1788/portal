...
<link href="../css/w1200/M-zwzd-yindao.css" id="cssName" rel="stylesheet" type="text/css">
...
$(document).ready(function(){
	...
	if (clienW >= 1280) {
		$("#cssName").attr("href","../css/w1200/M-zwzd-yindao.css");
	}else{
		$("#cssName").attr("href","../css/w980/M-zwzd-yindao.css");
		}

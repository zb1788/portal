...
<title>网上作业</title>
<link href="../css/w1200/T-wszy-yindao.css"  id="cssName" rel="stylesheet" type="text/css">
...
$(document).ready(function(){
	...
	if (clienW >= 1280) {
		$("#cssName").attr("href","../css/w1200/T-wszy-yindao.css");
	}else{
		$("#cssName").attr("href","../css/w980/T-wszy-yindao.css");
		}

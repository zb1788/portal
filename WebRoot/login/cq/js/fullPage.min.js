...
function FullPage(options) {
    ...
    indexNow =options.pageNow || 0,  //当前页
    browser = {},  //浏览器
    pageRange = {}, 
    cubicCurve = {},
    pageStyle = [],
    ...
    if (browser.cssCore !== "") {
        ...
        trans = function(o, x, y, t) {
            ...
            _interval = setInterval(function() {
                var _t;
                if ( + new Date > end) {
                    _t = e ? "left:" + x + "px;top:" + y + "px;": "left:" + x + "px;top:" + y + "px;";
                    clearInterval(_interval)
                } else {
                    diff = end - new Date;
                    pos = diff / t;
...
/*        setTimeout(function() {
    ...
    while (modeLen--) { (function(m) {
            switch (true) {
            case m === "wheel": wheelScroll = function(e) {
                    var direct;
                    e = e || window.event;
                    if (e.preventDefault) {
                        e.preventDefault()
                ...
                break;
            case m === "touch": if (!browser.addEventListener) {
                    break
                } (function() {

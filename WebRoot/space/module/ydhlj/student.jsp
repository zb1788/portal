...
$(document).ready(function(){
	...
	var tjmodule='<li><a href="~url~" target="_blank">~text~</a><time>~date~</time></li>';
	...
	util.getCommonCMS("loop1","CMS.JSON.A01074015002002",6,0,'<li><a  target=\"~target~\" href="~url~\" ><img src="~img~" alt="~text~" /><p>~text~</p></a></li>',true,function(code,data){
		loopindex++;
		try{
		$("#loop2").append('<li></li>');
		}catch(e){}
...
<div id="clContentBox">
    ...
    <div class="clBoxColWra">
        <aside class="clBoxCol2 clIcoList">
            ...
            <ul>
                <li>
                    <a class="clStudentMenuIco1" href="#" onclick="util.newPortalOpen('ILEARN.SCORE')">成绩</a>
                </li>
                <li>
                    <a class="clStudentMenuIco2" href="#" onclick="util.newPortalOpen('ILEARN.TEACHERMESSAGE')">教师消息</a>
                </li>
                <li>
                    <a class="clStudentMenuIco3" href="#" onclick="util.newPortalOpen('ILEARN.PARENTSAY')">爸妈对我说</a>
                </li>
                <li>
                    <a class="clStudentMenuIco4" href="#" onclick="util.newPortalOpen('ILEARN.STUDENTSAY')">同学对我说</a>
                </li>
                <li>
                    <a class="clStudentMenuIco5" href="#" onclick="util.newPortalOpen('ILEARN.OTHERSAY')">我想对他说</a>
                </li>
                <li>
                    <a class="clStudentMenuIco6" href="#" onclick="util.newPortalOpen('ILEARN.TEAMSTUDY')">小组学习</a>
                </li>
                <li>
                    <a class="clStudentMenuIco7" href="#" onclick="util.newPortalOpen('ILEARN.MYPRODUCT')">作品展示</a>
                </li>
            </ul>
        </aside>
        <div class="clBoxCol8">
            ...
            <article class="clListBox">
                ...
                <ul id="s_tuijian">
                    <li><a href="#">【精品试卷】小学思想品德、音乐、美术期末试卷精彩放送</a>

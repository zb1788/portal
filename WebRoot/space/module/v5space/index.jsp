...
<%
	...
	for(int st=0;st<menauthority.size();st++){
		...
		if("22".equals(tf.getParentid())){
			if(st==0){
				out.println("<li lmid='"+tf.getId()+"' src='#'><a style='cursor:hand'class='sel' >"+tf.getText()+"</a></li>");
				...
				if(tf.getHref()!=null || tf.getHref().trim().length()==0){
					if("4".equals(tf.getOpentype())){
						//新开页打开moduleurl配置连接
						out.println("<li lmid='"+tf.getId()+"' src='"+tf.getHref()+"' opentype='"+tf.getOpentype()+"' bg='"+tf.getIcon()+"' ><span>/</span><a style='cursor:hand' >"+tf.getText()+"</a></li>");
						...
						out.println("<li lmid='"+tf.getId()+"' src='"+url+"' opentype='"+tf.getOpentype()+"' bg='"+tf.getIcon()+"' ><span>/</span><a style='cursor:hand'>"+tf.getText()+"</a></li>");
					}else if("3".equals(tf.getOpentype())){
						//在框架内打开moduleurl配置连接
						out.println("<li lmid='"+tf.getId()+"' src='"+tf.getHref()+"' opentype='"+tf.getOpentype()+"' bg='"+tf.getIcon()+"' ><span>/</span><a href='"+tf.getHref()+"'  >"+tf.getText()+"</a></li>");
	    	...
	    	for(TreeForm sttree:(List<TreeForm>)tf1.getChildren()){
         	if("2".equals(usertype) || "3".equals(usertype)  || sttree.getC2()==null || sttree.getC2().trim().length()==0 || sttree.getC2().indexOf(eduAndGrade)>-1 ){
				...
				if("4".equals(sttree.getOpentype())){
					//新开页打开moduleurl配置连接
					out.println("<li lmid='"+sttree.getId()+"' src='"+sttree.getHref()+"' opentype='"+sttree.getOpentype()+"' bg='"+sttree.getIcon()+"' >"+splitStr+"<a style='cursor:hand'>"+sttree.getText()+"</a></li>");
					...
					out.println("<li lmid='"+sttree.getId()+"' src='"+url+"' opentype='"+sttree.getOpentype()+"' bg='"+sttree.getIcon()+"' >"+splitStr+"<a style='cursor:hand'>"+sttree.getText()+"</a></li>");

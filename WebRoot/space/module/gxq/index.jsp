...
//对于ie9采用ie8兼容模式
    ...
    <script charset="utf-8" src="<%=path %>/space/module/gxq/script/channels_v6.js?r=<%=dayStamp %>"></script>
    ...
    <script type="text/javascript">
        ...
        var screen_width_id = "1200";//记录屏幕宽度cookie
...
<div class="head_wrap">
    <div class="w1200">
        <div class="yj_logo"><img id="indexlogo" src="../public/images/logo.png"  alt=""/> <!--<span>教师空间</span>--></div>
        <div class="ssou_wrap" >
            <div class="ssou" >
                <div class="ssou_k">
                    <input type="text" id="researchKey" class="txt_ssou"  placeholder="请输入关键词" >
                    <input type="submit" class="souBtn_white" onClick="researchKeyResource();" value="搜索">
                </div>
                <!-- <div class="hot_search">热门搜索： <a class="purple" href="javascript:sendHotSearchSignForAnd('优选','http://jf.10086.cn/topics/100000000001142.html');">优教・优选</a> <a href="javascript:void(0);" onclick="hot     Search('同步备课',1); return false;">同步备课</a> <a href="javascript:void(0);" onclick="hotSearch('云盘',2); return false;">云盘</a> <a href="javascript:void(0);" onclick="hotSearch('教学',3); return false;">教学</a> <a href="javascript:void(0);" onclick="hotSearch('课堂训练',4); return false;">课堂训练</a> <a href="javascript:void(0);" onclick="hotSearch('课堂训练',4); return false;">导学</a> </div>-->
            </div>
        </div>
        <!-- 搜索end-->
        <div class="userInfo fr">
            <dl>
                ...
                <dd class="posRe">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <a  id="changerole" href="javascript:;" class="user">切换用户<i class="bottomdirection"></i></a>
                    <!--弹出层-->
		...
		<a id="persioncenter" href="#" onClick="clearMenuCur();util.openInFrame('TMS.CENTER');return false;">个人中心</a> /
		<span id="zxzf" style="display:none"><a style="cursor:pointer" href="#" target="_blank"> 支付</a> / </span>
		<a id="helplink" href="" target="_blank">帮助</a> /
		<a id="logoutwindow" href="/ssoLoginFail.jsp">退出</a></span>
...
<div class="w1200" style="display: none;">
    <div class="curPos" id="currentPos" style="display: none;"></div>
</div>

...
.con1012 .tips_sj.step2 {height:766px;overflow:hidden;background-position:0 -255px;top:305px;left:21px;display:none;}
...
<!--2013.1.6 添加升级提示弹出层-->
    <div class="con1012 xiao">
        ...
        <div class="tips_sj step3" id="pop_3">
        	<span class="guan" style="left:525px;top:50px;"><a href="javascript:void(0);" onclick="clos_sj();" title="关闭"></a></span>
            <span class="next" style="left:460px;top:180px;"><a href="javascript:void(0);" onclick="next_sj(3);" title="下一步"></a></span>
        </div>
        <!--frame4-->
